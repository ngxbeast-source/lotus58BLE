...
I have to fix my own board first to test the firmware any further. As far as I can see the LEDs work the OLED just sometimes wont come on? (I have  to test further if it's a hardware issue on my end)
    ...
    Most of this code was just copied in the structure of PandaKB's firmware. I have 0 experience with this, I read some of the zmk docs, and watched a few youtube videos going in. Then desperately asked ChatGPT for help whenever there were errors in the actions page.
